...
from community.views import StoriesList, CommunityTagsListCreate, CommunityList, CommunitySettingsView, \
    ...
    OpnSesameViewSet, StoryDetailView, CreativeCodeImportAPIView, CommunityAudienceListCreateView, FacebookPostStoryView
...
urlpatterns = [
    ...
    path('facebook-post-story/', FacebookPostStoryView.as_view(), name='facebook_post_view')
]
